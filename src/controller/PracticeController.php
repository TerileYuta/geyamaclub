    ...
    class Practice{
        ...
        public function get_data(){
            ...
            try{
                ...
                $plan = array(
                    ...
                    "income_other_memo" => $plan["income_other_memo"],
                    "gym" => $plan["gym"],
                    "shattle" => $plan["shattle"],
                    "spending_other" => $plan["spending_other"],
                    "spending_other_memo" => $plan["spending_other_memo"],
        ...
        public function settlement(){
            try{
                ...
                $spending_other = (int) $_POST['spending_other'];
                $spending_other_memo = $_POST['spending_other_memo'];
                ...
                $plan->income_other_memo = $income_other_memo;
                $plan->spending_other_memo = $spending_other_memo;
                $plan->spending_other = $spending_other;
                $plan->save();
                ...
                if($spending_other > 0){
                    $balance -= $spending_other;
                    $settlement = ORM::for_table("payments")->create();
                    $settlement->practice_id = $practice_id;
                    $settlement->name = $title;
                    $settlement->action = "-". $spending_other;
                    $settlement->balance = $balance;
                    $settlement->type = "その他の支出";
                    $settlement-> memo = $spending_other_memo;
                    $settlement->save();
